...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrepblock', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrepblock', {
    layout: 'basics',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrepnav', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrepnav', {
    layout: 'basics',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
...
router.get('/shoppnews', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('shoppnews', {
    layout: 'shop',
    navigation: {
      links: [
        {
...
router.get('/weeb', function (req, res) {
  //             ↙ cюди вводимо назву файлу з сontainer
  res.render('weeb', {
    layout: 'basics',
